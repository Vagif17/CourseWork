...
public class InvoiceManagerDB : IdentityDbContext<User>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(
            Customer =>
            {
                ...
                Customer.HasOne(c => c.User).WithMany(c => c.Customers).HasForeignKey(i => i.UserId).OnDelete(DeleteBehavior.Cascade);
            }
            );
