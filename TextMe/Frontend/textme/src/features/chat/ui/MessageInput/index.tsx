            ...
            <div className={`input-container ${recording ? "recording-active" : ""}`}>
                ...
                <div className="recording-wrapper">
                    <button
                        ...
                        onMouseDown={isReadyToSend ? undefined : startRecording}
                        onMouseUp={isReadyToSend ? undefined : stopRecording}
                        onMouseLeave={isReadyToSend ? undefined : () => recording && stopRecording()}
                        onClick={isReadyToSend ? handleSend : undefined}
                        title={isReadyToSend ? "Send" : "Hold to record"}
                    >
                        {isReadyToSend ? (
