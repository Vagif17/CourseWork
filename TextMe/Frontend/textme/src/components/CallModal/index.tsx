...
export default function CallModal({ webrtc }: Props) {
    const { callState, incomingCall, localStream, remoteStream, callTargetName, answerCall, rejectCall, endCall } = webrtc;
                ...
                {callState === "ringing" && incomingCall && (
                    <div className="call-incoming-view">
                        ...
                        <div className="call-actions">
                            <button className="call-btn answer-btn" onClick={() => answerCall(true)}>📹 Answer</button>
                            <button className="call-btn answer-audio-btn" onClick={() => answerCall(false)}>📞 Audio</button>
