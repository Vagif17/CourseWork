...
/** Plain-text messages starting with this prefix render as a rich news card in chat. */
...
export function serializeNewsChatMessage(article: NewsArticle): string {
    const payload: NewsChatPayloadV1 = {
        v: 1,
        title: article.title.slice(0, 400),
        link: article.link,
        source: article.source ?? null,
        summary: article.summary ? article.summary.slice(0, 220) : null,
...
export function tryParseNewsChatMessage(text: string | null | undefined): NewsArticle | null {
